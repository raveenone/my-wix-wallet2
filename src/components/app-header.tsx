...
export function AppHeader({ links = [] }: { links: { label: string; path: string }[] }) {
  ...
  return (
    <header className="relative z-50 px-4 py-2 bg-[#0E0017] dark:bg-[#0E0017] dark:text-neutral-400">
      <div className="mx-auto flex justify-between items-center">
        ...
        {showMenu && (
          <div className="md:hidden fixed inset-x-0 top-[52px] bottom-0 bg-[#0E0017]/95 dark:bg-[#0E0017]/95 backdrop-blur-sm">
